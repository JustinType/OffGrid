    ...
    if request.method == 'POST':
        ...
        if file == "" or file_name == "" or existing_path == "" or end == "" or next_slice == "":
            ...
            if existing_path == 'null':
                ...
                print("Title: " + str(type(file_folder.title)) + " " + file_folder.title)
                file_folder.os_version = os_version
                print("OS Version: " + str(type(file_folder.os_version)) + " " + file_folder.os_version)
                file_folder.investigators = investigators
                print("Investigators: " + str(type(file_folder.investigators)) + " " + file_folder.investigators)
                file_folder.description = description
                print("Description: " + str(type(file_folder.description)) + " " + file_folder.description)
                file_folder.status = "-1"
                file_folder.percentage = "0"
                file_folder.existingPath = file_name
                file_folder.eof = end
                print("EOF: " + str(type(file_folder.eof)) + " " + file_folder.eof)
